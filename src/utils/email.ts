    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 560px; margin: 0 auto; color: #191c1d;">
        ...
        <div style="padding: 32px 24px; border: 1px solid #E2E8F0; border-top: none;">
          ...
          <a href="https://www.jay-on.co.kr" style="display: inline-block; background: #0F172A; color: #fff; padding: 12px 32px; text-decoration: none; font-size: 13px; margin-top: 16px;">
            로그인 / Sign In
          </a>
        </div>
